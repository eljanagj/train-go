...
export default function AppRoutes({ theme, toggleTheme }) {
  return (
    <Routes>
      ...
      <Route
        path="/reviews"
        element={<Reviews theme={theme} toggleTheme={toggleTheme} />}
      />
      <Route
        path="/unauthorized"
        element={<Unauthorized theme={theme} toggleTheme={toggleTheme} />}
      />
      <Route
        path="/about"
      ...
      <Route
        ...
        element={
          <AdminRoute>
            <StationManagement theme={theme} toggleTheme={toggleTheme} />
          </AdminRoute>
        }
      />
      <Route
        path="/admin/trains/:trainId/seats"
        element={
          <AdminRoute>
      ...
      <Route
        ...
        element={
          <AdminRoute>
            <UsersPage theme={theme} toggleTheme={toggleTheme} />
          </AdminRoute>
        }
      />
    </Routes>
