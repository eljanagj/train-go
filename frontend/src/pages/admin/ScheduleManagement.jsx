            ...
            <div className="form-grid">
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNewSchedule({ ...newSchedule, trainID: e.target.value })
                  }
              ...
              <div className="form-group">
                ...
                {formErrors.routeID && (
                  <span className="error-message">{formErrors.routeID}</span>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                <TimeInput
                  ...
                  onChange={(time) =>
                    setNewSchedule({ ...newSchedule, departureTime: time })
                  }
              ...
              <div className="form-group">
                ...
                <TimeInput
                  ...
                  onChange={(time) =>
                    setNewSchedule({ ...newSchedule, arrivalTime: time })
                  }
