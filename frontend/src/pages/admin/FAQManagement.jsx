...
const FAQManagement = ({ theme, toggleTheme }) => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      fetchFaqs();
      setDeleteModal({ isOpen: false, faqId: null, question: '', isLoading: false });
    } catch (error) {
      ...
      <div className="management-page">
        ...
        <div className="management-form">
          <div className="management-form-header">
            <h2><FaQuestionCircle /> Add New FAQ</h2>
          </div>
          <div className="management-form-body">
            <div className="form-grid">
              <div className="form-group full-width">
                ...
                />
                {formErrors.question && <span className="error-message">{formErrors.question}</span>}
              </div>
              <div className="form-group full-width">
                ...
                <textarea
                  ...
                  rows="4"
                />
                {formErrors.answer && <span className="error-message">{formErrors.answer}</span>}
              </div>
        ...
        <div className="management-table-container">
          <h2><FaQuestionCircle /> Existing FAQs</h2>
          <table className="management-table">
            ...
            <tbody>
              {faqs.length === 0 ? (
                <tr><td colSpan="4" className="no-data">No FAQs found</td></tr>
              ) : (
                faqs.map((faq) => (
                  <tr key={faq.id}>
                    {editingFaq?.id === faq.id ? (
                      ...
                      <>
                        <td>{faq.question}</td>
                        <td style={{ wordWrap: 'break-word', whiteSpace: 'normal' }}>{faq.answer}</td>
                        <td style={{ verticalAlign: 'middle' }}>
                          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            <span
